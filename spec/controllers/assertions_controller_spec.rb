...
describe AssertionsController do
  ...
  def mock_assertion(stubs={})
    @mock_assertion ||= mock_model(Assertion, stubs).as_null_object
  end

  describe "GET index" do
    it "assigns all assertions as @assertions" do
      Assertion.stub(:all) { [mock_assertion] }
      get :index
      assigns(:assertions).should eq([mock_assertion])
    end
  end
